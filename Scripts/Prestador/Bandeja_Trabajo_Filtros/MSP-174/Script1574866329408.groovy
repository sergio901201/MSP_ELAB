...
//Press Tab
WebUI.sendKeys(findTestObject('Object Repository/PRESTADORES/Page_Bandeja Prestador/input_Fecha Hasta_vHASTA'), Keys.chord(Keys.TAB))

//Verify Element Present Fecha inválida
boolean errorF = WebUI.verifyElementPresent(findTestObject('Object Repository/PRESTADORES/Page_Bandeja Prestador/span_Fecha invlida (1)'), 30)
