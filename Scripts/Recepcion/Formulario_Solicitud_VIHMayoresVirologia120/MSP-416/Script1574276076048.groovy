...
//Select option No Reactivo in Tamizaje por EIA
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/Page_Solicitud VIH Mayores/select_TAMIZAJE EIAQUIMIOMEIAOTROS'), "N", true)

//Write Marca Comercial NULL
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Marca Comercial_SOL_TAMEIAYOTROSMARCA'), "")
...
if (alert) {
    println('Debe especificar la Marca Comercial, Prueba Correcta')
} else {
