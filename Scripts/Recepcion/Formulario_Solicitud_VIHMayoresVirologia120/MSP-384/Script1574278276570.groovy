...
//Select Indeterminado/Inválido in Prueba Rápida 2
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/Page_Solicitud VIH Mayores/select_PRUEBARAPIDA2'), "N", true)

//Write Marca Comercial NULL
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Marca Comercial_SOL_TAMALGORITPRRAP2MARCA'), "")
...
if (alert) {
    println('Debe especificar una Marca Comercial, Prueba Correcta')
} else {
