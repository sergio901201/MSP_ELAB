...
//Select option Indeterminado in Tamizaje por EIA
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/Page_Solicitud VIH Mayores/select_TAMIZAJE EIAQUIMIOMEIAOTROS'), "I", true)

//Write Marca Comercial
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Marca Comercial_SOL_TAMEIAYOTROSMARCA'), "Marca Comercial de Prueba")

//Write Valor de la Muestra/Punto de corte
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Valor de la MuestraPunto de corte_SOL_TAMVALORMUESTRA'), "5,40")

//Select Generacion NINGUNO
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/Page_Solicitud VIH Mayores/select_GENERACION'), "0", true)
...
if (alert) {
    println('Debe especificar la Generación, Prueba Correcta')
} else {
