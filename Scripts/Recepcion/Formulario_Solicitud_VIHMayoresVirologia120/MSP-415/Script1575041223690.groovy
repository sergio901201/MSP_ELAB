...
//Select Code Study
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Ingreso Solicitud/input_Cdigo_vPEST_ID'), codigo1)
...
//Select Country
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/select_PAIS'), Pais, true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/select_TIPO_DOCUMENTO'), '1', true)
...
//Document Number
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/input_-_vSOL_PACIENTENRODOCUMENTO'), NoDoc)
...
String resultFH = f.FechaActual()

//Insert Fecha de Recolección de la Muestra
WebUI.executeJavaScript('$("#SOL_FECHAEXTRACCION").val("'+resultFH+'");', null)
...
if(PEO){
	...
	//Select Diarrea oportunista SI
	WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/ENFERMEDADES OPORTUNISTAS/Page_Solicitud VIH Mayores/input_Si_SOL_ENFOPDIARREAOPORTUNISTA'))
	
	//Select Encefalopatía por VIH NO
	WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/ENFERMEDADES OPORTUNISTAS/Page_Solicitud VIH Mayores/input_No_SOL_ENFOPENCEFPORVIH'))
	
	//Select Bacteriemia recurrente por Salmonella SI
	WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/ENFERMEDADES OPORTUNISTAS/Page_Solicitud VIH Mayores/input_Si_SOL_ENFOPBACRECUSALMONELLA'))
	
	//Select Síndrome de desgaste NO
	WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/ENFERMEDADES OPORTUNISTAS/Page_Solicitud VIH Mayores/input_No_SOL_ENFOPSINDRDESGASTE'))
	
	//Select Otra SI
	WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/ENFERMEDADES OPORTUNISTAS/Page_Solicitud VIH Mayores/input_Si_SOL_ENFOPOTRA'))
...
CRUD crud = new CRUD()
boolean result = crud.InsertSolicitudCepas(NoDoc, Pais, codigo1)

String documento = WebUI.executeJavaScript('return $("#span_SOL_PACIENTENRODOCUMENTO_0001").text();', null)

println ("El documento de la Bandeja es:" + documento)

if (result && documento == NoDoc) {
    println('Se insertó correctamente, Prueba Correcta')
} else {
