...
//Write Valor de la Muestra/Punto de corte NULL
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Valor de la MuestraPunto de corte_SOL_TAMVALORMUESTRA'), "")
...
if (alert) {
    println('Debe especificar un Valor de Muestra/Punto de Corte, Prueba Correcta')
} else {
