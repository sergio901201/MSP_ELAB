...
//Select Práctica Sexual Hombre NO
WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/INFECCION POR VIH-1/Page_Solicitud VIH Mayores/input_No_SOL_PRACTICASEXUALHOMBRE'))
...
if (alert) {
    println('Debe especificar un Extranjero, Prueba Correcta')
} else {
