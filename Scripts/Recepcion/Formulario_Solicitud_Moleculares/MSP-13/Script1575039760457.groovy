...
//Select Code Study
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Ingreso Solicitud/input_Cdigo_vPEST_ID'), codigo[0])
...
CRUD crud = new CRUD()
boolean result = crud.InsertSolicitudCepas(NoDoc, Pais, codigo[0])
