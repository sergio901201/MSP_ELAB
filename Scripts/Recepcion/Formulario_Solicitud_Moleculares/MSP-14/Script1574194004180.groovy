...
//Select Code Study
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Ingreso Solicitud/input_Cdigo_vPEST_ID'), codigo22)
...
if (alert) {
	println('Debe especificar un paciente, Prueba Correcta')
} else {
