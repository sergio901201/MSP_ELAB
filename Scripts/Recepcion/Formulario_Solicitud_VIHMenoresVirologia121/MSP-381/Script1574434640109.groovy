...
//Centro Asistencial de Procedencia
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/Page_Solicitud VIH Mayores/input_Centro asistencial de procedencia_SOL_CENTROASISPROC'), "Centro asistencial de procedencia de prueba")
...
//Número de Documento de la Madre NULL
WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/INFECCION POR VIH-1/Page_Solicitud VIHMenores/input_-_vSOL_MADRENRODOCUMENTO'))
...
if (alert) {
	println('Debe especificar un Número de Documento para la Madre, Prueba Correcta')
} else {
