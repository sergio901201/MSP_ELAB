...
//Select Code Study
WebUI.setText(findTestObject('Object Repository/RECEPCION/Page_Ingreso Solicitud/input_Cdigo_vPEST_ID'), codigo[7])
...
//Press click
WebUI.click(findTestObject('Object Repository/RECEPCION/Page_Solicitud Cepas/input_Nmero de hijo(si corresponde)_SOL_NRODEHIJOS'))
...
CRUD crud = new CRUD()
boolean result = crud.InsertSolicitudCepas(NoDoc, Pais, codigo[7])
