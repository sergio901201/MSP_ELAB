...
ExcelData ED = findTestData('Data Files/VIROLOGIA/DataBase Data Estudios')

String estudio = ED.getValue(1,9)

estudio = estudio.substring(0,estudio.length()-2)
...
CRUD crud = new CRUD()
String[] resultFC = crud.FiltroEstudioVirologia(fechaBDD, fechaBDH, estudio)
...
if (filtroF) {
    println('El filtro Estudio funciona correctamente, Prueba Correcta')
} else {
