...
if(longitud > 0){
	solicitud = WebUI.executeJavaScript('return $("#span_vSOL_NUMERO_0001").text();', null)
	WebUI.setText(findTestObject('Object Repository/Virologia/Page_Bienvenida/Page_Bandeja de trabajo de Unidades (1)/input_Nro Solicitud_vSOL_NUMERO_FILTRO'), solicitud)
}
...
CRUD crud = new CRUD()
String[] resultFC = crud.FiltroSolicitudVirologia(fechaBDD, fechaBDH, solicitud)
