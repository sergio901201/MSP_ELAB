...
String pacienteDoc, pacienteNum, paciente


if (longitud > 0) {
    //Obtener el Tipo de Documento y el Nro de Documento para un Paciente (#6) mostrado en pantalla
	pacienteDoc = WebUI.executeJavaScript('return $("#span_vSOL_PACIENTETIPODOCPREFIJO_0006").text();', null).toString()
    pacienteNum = WebUI.executeJavaScript('return $("#span_vSOL_PACIENTENRODOCUMENTO_0006").text();', null)
	
	ContarRowsTable crt = new ContarRowsTable()
	paciente = crt.TipoDocumentoPaciente(pacienteDoc)
	
	//Select Tipo de Documento para el Paciente
	WebUI.selectOptionByValue(findTestObject('Object Repository/Virologia/Page_Bienvenida/Page_Bandeja de trabajo de Unidades (1)/select_CCCIDNIDNILELNNVPSD'), paciente, true)
	
	//Insert Nro Documento para el Paciente
	WebUI.setText(findTestObject('Object Repository/Virologia/Page_Bienvenida/Page_Bandeja de trabajo de Unidades (1)/input_Paciente_vPACIE_NRODOCUMENTO'), pacienteNum)
...
String[] resultFC = crud.FiltroPacienteVirologia(fechaBDD, fechaBDH, pacienteNum)
