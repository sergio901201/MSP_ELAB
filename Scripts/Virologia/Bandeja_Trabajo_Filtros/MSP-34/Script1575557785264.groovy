...
String Estado = IDEstado.getValue(1, 1)
...
CRUD crud = new CRUD()
String[] resultFC = crud.FiltroEstadoVirologia(fechaBDD, fechaBDH, Estado)
...
if (filtroF) {
    println('El filtro Estado funciona correctamente, Prueba Correcta')
} else {
