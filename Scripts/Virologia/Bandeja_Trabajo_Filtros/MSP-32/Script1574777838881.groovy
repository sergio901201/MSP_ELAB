...
WebUI.executeJavaScript('$("#vFECHADESDE").val("20/11/19");', null)
...
WebUI.executeJavaScript('$("#vFECHAHASTA").val("'+fecha+'");', null)
...
boolean errorF = WebUI.verifyElementPresent(findTestObject('Object Repository/Virologia/Page_Bienvenida/Page_Bandeja de trabajo de Unidades (1)/span_Fecha invlida (1)'), 30)
