...
CRUD crud = new CRUD()
String[] resultFC = crud.FiltroEstadoEstudioVirologia(fechaBDD, fechaBDH, EstadoEstudio)
...
if (filtroF) {
    println('El filtro EstadoEstudio funciona correctamente, Prueba Correcta')
} else {
