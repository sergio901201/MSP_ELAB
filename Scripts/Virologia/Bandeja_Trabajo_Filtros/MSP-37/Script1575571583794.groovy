...
WebUI.executeJavaScript('$("#vSOL_INGRESODLSP").click();', null)

boolean dlsp = WebUI.executeJavaScript('return $("#vSOL_INGRESODLSP").prop("checked");', null)
println ("El valor de la booleana es:" + dlsp)
...
CRUD crud = new CRUD()
String[] resultFC = crud.FiltroDLSPVirologia(fechaBDD, fechaBDH, dlsp)
...
if (filtroF) {
    println('El filtro Solo Ingresadas por DLSP funciona correctamente, Prueba Correcta')
} else {
