...
//click en Confirmar dejando en blanco el Pedido de Información
/*WebUI.click(findTestObject('Object Repository/Virologia/Page_Ingreso de Resultado/input_Est_Sec_Id_BTN_CANCEL'))*/
WebUI.executeJavaScript('$("#gxp0_ifrm").contents().find("#BUTTON2").click();', null)
WebUI.delay(2)

//Verificar que se muestra un span con el Error por dejar el Pedido de Información en blanco
PInformacion = WebUI.executeJavaScript('return $("#gxp0_ifrm").contents().find("#gxErrorViewer div.gx-warning-message").length;', null)
...
if (filtroF) {
    println("Para el Estudio: $estudio, Muestra: $muestra y Solicitud Número: $numeroSOL, el Pedido de Información no puede estar vacío, funciona correctamente, Prueba Correcta")
} else {
