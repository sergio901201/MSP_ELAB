...
//Escribir libremente un Pedido de Información
WebUI.executeJavaScript('$("#gxp0_ifrm").contents().find("#vSOLICITUDINFORMACIONMENSAJE").val("Prueba para cambiar el Pedido de Información");', null)
WebUI.delay(2)
...
if (filtroF) {
    println("Para el Estudio: $estudio, Muestra: $muestra y Solicitud Número: $numeroSOL, el Pedido de Información se mantuvo con el valor: $resultFC1, funciona correctamente, Prueba Correcta")
} else {
