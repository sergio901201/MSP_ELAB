...
/*WebUI.executeJavaScript('$("$("#TABLE1.Table tbody tr td input#BUTTON1.Button").click();").click();', null)*/
WebUI.click(findTestObject('Object Repository/Virologia/Page_Ingreso de Resultado/input_Confirma liberar todos los exmenes_BUTTON1'))
...
if (filtroF) {
    println("Para el Estudio: $estudio, Muestra: $muestra y Solicitud Número: $numeroSOL, Todos los Exámen fueron Liberados, funciona correctamente, Prueba Correcta")
} else {
