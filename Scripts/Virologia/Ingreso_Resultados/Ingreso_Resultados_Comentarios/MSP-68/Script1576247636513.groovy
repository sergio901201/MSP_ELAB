...
if (filtroF) {
    println("Para el Estudio: $estudio, Muestra: $muestra y Solicitud Número: $numeroSOL, el comentario era el siguiente: $resultFC, y ahora después de Confirmar es: $resultFC1, funciona correctamente, Prueba Correcta")
} else {
