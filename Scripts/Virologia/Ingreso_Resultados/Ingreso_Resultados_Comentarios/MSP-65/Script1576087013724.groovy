...
//Escribir libremente un Comentario
WebUI.executeJavaScript('$("#gxp0_ifrm").contents().find("#vSOLICITUDCOMENTARIODESCRIPCION").val("Prueba para cambiar el Comentario");', null)
WebUI.delay(2)

//click en Cancelar
/*WebUI.click(findTestObject('Object Repository/Virologia/Page_Ingreso de Resultado/input_Est_Sec_Id_BTN_CANCEL'))*/
WebUI.executeJavaScript('$("#gxp0_ifrm").contents().find("#BUTTON1").click();', null)
WebUI.delay(2)
...
if (filtroF) {
    println("Para el Estudio: $estudio, Muestra: $muestra y Solicitud Número: $numeroSOL, el comentario se mantuvo con el valor: $resultFC1, funciona correctamente, Prueba Correcta")
} else {
