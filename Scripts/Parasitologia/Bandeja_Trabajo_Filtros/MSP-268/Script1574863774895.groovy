...
WebUI.executeJavaScript('$("#vDESDE").val("'+result+'");', null)
...
WebUI.executeJavaScript('$("#vHASTA").val("'+fecha+'");', null)

//Press Tab
WebUI.sendKeys(findTestObject('Object Repository/PARASITOLOGIA_MICOLOGIA/Page_Bandeja Micologa - Parasitologa/input_Fecha Hasta_vHASTA'), Keys.chord(Keys.TAB))

//Verify Element Present Fecha inválida
boolean errorF = WebUI.verifyElementPresent(findTestObject('Object Repository/PARASITOLOGIA_MICOLOGIA/Page_Bandeja Micologa - Parasitologa/span_Fecha invlida (1)'), 30)

if(errorF){
	println ('Debe especificar una Fecha Hasta válida, Prueba Correcta')
}
else{
